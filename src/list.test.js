const { EMPTY, car, cdr, Cons, fold, map } = require("./list.js")
...
describe("Cons", () => {
  ...
  test("fold", () => {
    expect(fold((a, b) => a + b, 0)(Cons(2, Cons(3, Cons(5, EMPTY))))).toEqual(
      10
    )
  })

  test("map", () => {
    expect(String(map(x => x * 2)(Cons(2, Cons(3, EMPTY))))).toEqual(
      "(4 . (6 . ()))"
    )
  })
})
